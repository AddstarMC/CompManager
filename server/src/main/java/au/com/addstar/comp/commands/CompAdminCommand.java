...
public final class CompAdminCommand extends RootCommandDispatcher {
	public CompAdminCommand(WhitelistHandler whitelist, CompManager manager, NotificationManager notificationManager, ConfirmationManager confirmations, PlotBackupService backupService) {
		...
		registerCommand(new BackupCommand(manager, backupService));
	}
}
